...
if ($guias->feito == true) {
    echo "<input type='checkbox' name='checkbox_feito' id='checkbox_feito' checked disabled>";
} else {
    echo "<input type='checkbox' name='checkbox_feito' id='checkbox_feito' disabled>";
}
echo "<label for='checkbox_feito'>Feito</label>";
echo "</fieldset>";
echo "</div>"; // Fecha ui-grid-solo
